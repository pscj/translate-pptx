...
# def prompt_deepseek(message: str, model="Pro/deepseek-ai/DeepSeek-V3.2-Exp"):
#     """A prompt helper function that sends a message to openAI
#     and returns only the text response.
#     Results are cached to optimize for repeated queries.
#     """
...
async def prompt_deepseek_async(message: str, model="Pro/deepseek-ai/DeepSeek-V3.2-Exp"):
